...
parsed_papers = [
    {
        "id": "scholar_0_3750456177397365716",
    ...
    {
        "id": "scholar_1_2885948528328717397",
    ...
    {
        "id": "scholar_2_3090976042647795153",
    ...
    {
        "id": "scholar_3_-7063551814203978322",
    ...
    {
        "id": "scholar_4_1787794226783943358",
    ...
    {
        "id": "scholar_5_-9089680536470977564",
        ...
        "impact_factor": "谷歌学术不提供",
        "研究背景": "不同相位 retrieval 算法（直接法如WDD vs 迭代法如Ptychography）在4D-STEM成像中信息传递效率存在差异，需要从信息论角度进行分析比较，帮助理解不同算法特性。",
    ...
    {
        "id": "scholar_6_-1602468774618185298",
    ...
    {
        "id": "scholar_7_7690323651144052888",
    ...
    {
        "id": "scholar_8_-2958691324052829984",
    ...
    {
        "id": "scholar_9_-6996421714356192305",
...
def append_to_excel(papers: list):
    ...
    print("新增论文已成功保存到 Excel 文件，路径：%s" % BASE_CONFIG['EXCEL_SAVE_PATH'])
